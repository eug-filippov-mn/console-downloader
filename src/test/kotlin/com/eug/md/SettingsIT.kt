...
class SettingsIT {
    ...
    @Test
    fun `setting creation should throw exception with missing required options msg when options is empty`() {
        val notValidOptionsException = Assertions.assertThrows(NotValidOptionsException::class.java) {
            Settings.from(emptyArray())
        }
        assertEquals("Missing required options: n, f, o, l", notValidOptionsException.message)
    }

    @Test
    fun `setting creation from options where thread number is not a number should throw exception with valid msg`() {
        val options = arrayOf(
                "-n", "notANumber",
    ...
    @Test
    fun `setting creation from options where thread number is negative should throw exception with valid msg`() {
        val options = arrayOf(
                "-n", "-10",
                "-f", linksFile.absolutePath,
                "-o", outDir.absolutePath,
    ...
    @Test
    fun `setting creation from options where thread number is zero should throw exception with valid msg`() {
        val options = arrayOf(
                "-n", "0",
                "-f", linksFile.absolutePath,
                "-o", outDir.absolutePath,
    ...
    @Test
    fun `setting creation from options where links file does not exist should throw exception with valid msg`() {
        val options = arrayOf(
    ...
    @Test
    fun `setting creation from options where links file is directory should throw exception with valid msg`() {
    ...
    @Test
    fun `setting creation from options where links file is not readable should throw exception with valid msg`() {
    ...
    @Test
    fun `setting creation from options where out dir is file should throw exception with valid msg`() {
    ...
    @Test
    fun `setting creation from options where out dir hasn't write permissions should throw exception with valid msg`() {
    ...
    @Test
    fun `setting creation from options where out dir does not exists should create settings`() {
        ...
        val settings = Settings.from(options)
    ...
    @Test
    fun `setting creation from options where speed not a number should throw exception with valid msg`() {
        val options = arrayOf(
                "-n", DEFAULT_THREADS_NUMBER,
                "-f", linksFile.absolutePath,
                "-o", outDir.absolutePath,
    ...
    @Test
    fun `setting creation from options where speed multiplier is not k or m should throw exception with valid msg`() {
        val options = arrayOf(
                "-n", DEFAULT_THREADS_NUMBER,
                "-f", linksFile.absolutePath,
                "-o", outDir.absolutePath,
    ...
    @Test
    fun `setting creation from valid options should create settings properly`() {
        val options = arrayOf(
                "-n", DEFAULT_THREADS_NUMBER,
                "-f", linksFile.absolutePath,
                "-o", outDir.absolutePath,
